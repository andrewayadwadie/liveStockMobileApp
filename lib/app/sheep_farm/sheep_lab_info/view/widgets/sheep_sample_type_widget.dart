...
import '../../controller/sheep_sample_type_controller.dart';
 

class SheepSampleTypeWidget extends StatelessWidget {
  const SheepSampleTypeWidget({
    Key? key,
...
final int sampleIndex ;
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SheepSampleTypeController>(
        init: SheepSampleTypeController(),
        builder: (controller) {
