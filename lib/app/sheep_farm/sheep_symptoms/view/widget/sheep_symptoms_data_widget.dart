...
class SheepsymptomsDataWidget extends StatelessWidget {
  SheepsymptomsDataWidget({Key? key}) : super(key: key);

  List<String> symptomsWay = [];
  SheepSendsymptomsDataController sendsymptomsDataController =
      Get.put(SheepSendsymptomsDataController(), permanent: true);
