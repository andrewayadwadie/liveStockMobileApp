...
import '../../controller/sheep_miscarriage_time_controller.dart';

class SheepMiscarriageTimeWidget extends StatelessWidget {
  const SheepMiscarriageTimeWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<SheepMiscarriageTimeController>(
        init: SheepMiscarriageTimeController(),
        builder: (controller) {
