...
class HorseDiseaseDataWidget extends StatelessWidget {
  HorseDiseaseDataWidget({Key? key}) : super(key: key);

  List<String> diseaseWay = [];
  HorseSendDiseaseDataController sendDiseaseDataController =
      Get.put(HorseSendDiseaseDataController(), permanent: true);
