...
class HorsesymptomsDataWidget extends StatelessWidget {
  HorsesymptomsDataWidget({Key? key}) : super(key: key);

  List<String> symptomsWay = [];
  HorseSendsymptomsDataController sendsymptomsDataController =
      Get.put(HorseSendsymptomsDataController(), permanent: true);
