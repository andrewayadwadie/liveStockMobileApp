...
import '../../horse_general_management/view/screen/horse_general_management_screen.dart';
...
showDialog(
        ...
        builder: (context) => FutureProgressDialog(
          SendHorseHerdData.sendHorseHerdData(
...
log("herd ${ FarmHorseHerdPref.getHorseHerdValue()}");
    if (res.runtimeType == double) {
      FarmHorseHerdPref.setHorseHerdValue(res.toInt());
      log("Horse herd response in local storage double ${FarmHorseHerdPref.getHorseHerdValue()}");
