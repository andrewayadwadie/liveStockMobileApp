...
import '../../controller/horse_herd_dynasty_controller.dart';
 

class HorseDynastyWidget extends StatelessWidget {
  const HorseDynastyWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<HorseHerdDynastyController>(
        init: HorseHerdDynastyController(horseHerdId: 5),
        builder: (controller) {
