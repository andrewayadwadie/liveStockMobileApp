...
import '../../controller/horse_antibiotics_type_controller.dart';

class HorseAntibioticsTypeWidget extends StatelessWidget {
  const HorseAntibioticsTypeWidget({ Key? key }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<HorseAntibioticsTypeController>(
        init: HorseAntibioticsTypeController(),
        builder: (controller) {
