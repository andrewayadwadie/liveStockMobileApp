...
import '../../controller/goat_sample_type_controller.dart';
 

class GoatSampleTypeWidget extends StatelessWidget {
  const GoatSampleTypeWidget({
    Key? key,
...
final int sampleIndex ;
  ...
  Widget build(BuildContext context) {
    return GetBuilder<GoatSampleTypeController>(
        init: GoatSampleTypeController(),
        builder: (controller) {
