...
class GoatDiseaseDataWidget extends StatelessWidget {
  GoatDiseaseDataWidget({Key? key}) : super(key: key);

  List<String> diseaseWay = [];
  GoatSendDiseaseDataController sendDiseaseDataController =
      Get.put(GoatSendDiseaseDataController(), permanent: true);
