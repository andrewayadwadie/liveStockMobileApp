...
class GoatsymptomsDataWidget extends StatelessWidget {
  GoatsymptomsDataWidget({Key? key}) : super(key: key);

  List<String> symptomsWay = [];
  GoatSendsymptomsDataController sendsymptomsDataController =
      Get.put(GoatSendsymptomsDataController(), permanent: true);
