...
import '../../goat_feeding/view/screen/goat_feeding_screen.dart';
...
class GoatHousingSendDataController extends GetxController {
  ...
  GoatCleanFloorController cleanFloorCtrl =
      Get.put(GoatCleanFloorController());
...
sendDataCtrl.addAnswer(id: 329, answer: "");
    ...
    } else if(feedingStatusCtrl.charcter == GoatFeedingStausRadio.specificTimesaDay) {
  ...
  void sendGoatHousingData( BuildContext context) async {
    ...
    var res = await SendGoatGeneralDataService.sendGoatGeneralDataService(
        data: sendDataCtrl.answers);
    if (res == 200) {
      FarmGoatStatusPref.setGoatStatusValue(2);
