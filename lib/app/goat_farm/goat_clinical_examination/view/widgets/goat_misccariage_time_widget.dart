...
import '../../controller/goat_miscarriage_time_controller.dart';
 

class GoatMiscarriageTimeWidget extends StatelessWidget {
  const GoatMiscarriageTimeWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<GoatMiscarriageTimeController>(
        init: GoatMiscarriageTimeController(),
        builder: (controller) {
