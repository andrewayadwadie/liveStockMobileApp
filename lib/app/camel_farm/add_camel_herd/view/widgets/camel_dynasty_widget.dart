...
class CamelDynastyWidget extends StatelessWidget {
  const CamelDynastyWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CamelHerdDynastyController>(
        init: CamelHerdDynastyController(camelHerdId: 2),
        builder: (controller) {
