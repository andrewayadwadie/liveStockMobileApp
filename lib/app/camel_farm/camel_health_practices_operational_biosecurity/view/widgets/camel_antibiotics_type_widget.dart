...
import '../../controller/camel_antibiotics_type_controller.dart';
 
class CamelAntibioticsTypeWidget extends StatelessWidget {
  const CamelAntibioticsTypeWidget({ Key? key }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CamelAntibioticsTypeController>(
        init: CamelAntibioticsTypeController(),
        builder: (controller) {
