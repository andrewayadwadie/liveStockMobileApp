...
import '../../controller/camel_sample_type_controller.dart';

class CamelSampleTypeWidget extends StatelessWidget {
  const CamelSampleTypeWidget({
    Key? key,
...
final int sampleIndex ;
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CamelSampleTypeController>(
        init: CamelSampleTypeController(),
        builder: (controller) {
