...
class CamelDiseaseDataWidget extends StatelessWidget {
  CamelDiseaseDataWidget({Key? key}) : super(key: key);

  List<String> diseaseWay = [];
  CamelSendDiseaseDataController sendDiseaseDataController =
      Get.put(CamelSendDiseaseDataController(), permanent: true);
