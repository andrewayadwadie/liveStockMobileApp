...
class CamelsymptomsDataWidget extends StatelessWidget {
  CamelsymptomsDataWidget({Key? key}) : super(key: key);

  List<String> symptomsWay = [];
  CamelSendsymptomsDataController sendsymptomsDataController =
      Get.put(CamelSendsymptomsDataController(), permanent: true);
