...
import '../../controller/cow_herd_dynasty_controller.dart';
 

class CowDynastyWidget extends StatelessWidget {
  const CowDynastyWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CowHerdDynastyController>(
        init: CowHerdDynastyController(cowHerdId: 1),
        builder: (controller) {
