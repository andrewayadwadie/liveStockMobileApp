...
import '../../controller/cow_sample_type_controller.dart';
 

class CowSampleTypeWidget extends StatelessWidget {
  const CowSampleTypeWidget({
    Key? key,
...
final int sampleIndex ;
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CowSampleTypeController>(
        init: CowSampleTypeController(),
        builder: (controller) {
