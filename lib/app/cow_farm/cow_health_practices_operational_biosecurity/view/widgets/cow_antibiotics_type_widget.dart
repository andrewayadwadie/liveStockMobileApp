...
import '../../controller/cow_antibiotics_type_controller.dart';

class CowAntibioticsTypeWidget extends StatelessWidget {
  const CowAntibioticsTypeWidget({ Key? key }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CowAntibioticsTypeController>(
        init: CowAntibioticsTypeController(),
        builder: (controller) {
